 ...
 *
 */
public class OmotoReportDAO extends HibernateDaoSupport implements CommonDAOInterface{
	...
	public List getAllRecords() throws HibernateException{
		return (List) getHibernateTemplate().execute(new HibernateCallback() {
            ...
            public Object doInHibernate(Session session)
                ...
                List result = session.createQuery("from OmotoReport o ORDER BY o.id DESC").list();
                return result;
            }
		...
		return getHibernateTemplate().execute(
                new HibernateCallback() {
                    public Object doInHibernate(Session session)
                        ...
                        return session.createQuery("from OmotoReport o where o.id = ? ")
